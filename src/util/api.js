...
class Api {
  constructor() {
    ...
    this._newsSearchUrl = `https://nomoreparties.co/news/v2/everything?language=en&pageSize=100&sortBy=publishedAt&from=${this._searchFromDate}&to=${this._currentDate}&`;
  }
