        ...
        <ul className='news-results__cards-list'>
          ...
          <li className='news-results__cards-item'>
            <div className='news-results__card'>
              ...
              <button className="news-results__card-save-btn"></button>
              <p className='news-results__card-date news-results__card_text news-results__card_text_date'>November 4, 2020</p>
              ...
              <p className='news-results__card-abstract news-results__card_text news-results__card_text_abstract'>
                ...
                Jon Young, is for both adults and children to asdfasfj a;lsfja lsfjas;dfjasd
              </p>
              <p className='news-results__card-source news-results__card_text news-results__card_text_source'>treehugger</p>
            </div>
          </li>
